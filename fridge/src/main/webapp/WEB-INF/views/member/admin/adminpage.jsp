...
<body>
	...
	<p class="paging">
		<c:if test="${requestScope.lvo.pagingBean.previousPageGroup}">
			<a
				href="${initParam.root}admin_adminpage.do?pageNo=${requestScope.lvo.pagingBean.
   ...
   ${i}
    ...
    --%>
		<c:if test="${requestScope.lvo.pagingBean.nextPageGroup}">
			<a
				href="admin_adminpage.do?pageNo=${requestScope.lvo.pagingBean.endPageOfPageGroup+1}">
				▶ </a>
		</c:if>
	</p>
</body>
